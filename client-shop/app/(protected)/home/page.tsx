  ...
  return (
    <main className="min-h-screen bg-neutral-950 text-white">
      <section className="max-w-7xl mx-auto px-6 pt-20 pb-16">
        ...
        <p className="text-neutral-400 text-lg max-w-xl leading-relaxed mb-10">
        ...
        <div className="flex flex-wrap gap-4">
          <button className="px-8 py-3 bg-green-400 text-neutral-950 font-bold rounded-xl hover:bg-green-300 transition-colors text-sm tracking-wide">
            Browse Sprites
          </button>
          <button className="px-8 py-3 bg-transparent border border-neutral-700 hover:border-green-400/50 text-white font-medium rounded-xl transition-colors text-sm">
            View Pricing
          </button>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-6 pb-20">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-px bg-neutral-800 rounded-2xl overflow-hidden border border-neutral-800">
          <div className="bg-neutral-950 p-8 hover:bg-green-950/20 transition-colors">
            <div className="w-10 h-10 rounded-xl bg-green-950 border border-green-400/20 flex items-center justify-center mb-5">
              <svg className="w-5 h-5 text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
              </svg>
            </div>
            <h3 className="text-white font-bold text-lg mb-2">Browse & Discover</h3>
          ...
          <div className="bg-neutral-950 p-8 hover:bg-green-950/20 transition-colors">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Buy or Subscribe</h3>
            <p className="text-neutral-400 text-sm leading-relaxed">
          ...
          <div className="bg-neutral-950 p-8 hover:bg-green-950/20 transition-colors">
            ...
            <h3 className="text-white font-bold text-lg mb-2">Integrate Instantly</h3>
            <p className="text-neutral-400 text-sm leading-relaxed">
