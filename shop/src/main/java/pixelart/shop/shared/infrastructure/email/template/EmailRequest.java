...
public class EmailRequest {
    ...
    public static EmailRequest otp(String to, String otp) {
    ...
    public static EmailRequest orderConfirmation(String to, String orderId, String username) {
        return EmailRequest.builder()
                .to(to)
                .template(EmailTemplate.ORDER_CONFIRMATION)
                .data(Map.of("orderId", orderId, "username", username))
                .subjectArgs(new Object[]{orderId})
                .build();
    }
}